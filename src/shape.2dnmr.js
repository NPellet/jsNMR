...
define( [ 'require', 'graphs/shapes/graph.shape.rect' ], function( require, GraphRect ) {

	"use strict";
	var lineHeight = 5;

	var GraphNmrSignal2D = function( graph, options ) {
	...
	$.extend( GraphNmrSignal2D.prototype, GraphRect.prototype, {
